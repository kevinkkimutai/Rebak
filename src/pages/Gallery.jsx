...
<div className="border mt-4 mx-8"></div>
  ...
  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 pt-10 md:mx-8 mx-2 md:mb-10">
    <div className="grid gap-4">
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/perimeter fencing 2 (2).jpg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/sample perimeter fence.jpg" alt="" />
        </div>
        
    </div>
    <div className="grid gap-4">
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/sample chainlink 2.jpg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/sample wooden fence.jpeg" alt="" />
        </div>
       
    </div>
    <div className="grid gap-4">
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/sample home fence.jpg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/sample chainlink 3.jpg" alt="" />
        </div>
        
    </div>
    <div className="grid gap-4">
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/sample chainlink 4.jpg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/barb (1).jpg" alt="" />
        </div>
